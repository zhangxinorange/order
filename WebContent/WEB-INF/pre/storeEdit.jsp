...
<body>
<form action="${path }/store/update" method="post">
...
<input type="hidden" name="id" value="${record.id }"/>
    <div class="tiao1">
        ...
        <div class="tiao_r"><span><input type="text" name="r_name" value="${record.r_name }" required class="srk" /></span></div>
    </div>
    <div class="tiao1">
        <div class="tiao_l"><span>单位</span></div>
        <div class="tiao_r"><span><input type="text" name="r_unit" value="${record.r_unit }" required class="srk" /></span></div>
    </div>
    <div class="hui"></div>
    <div class="tiao1">
        <div class="tiao_l"><span>当前库存</span></div>
        <div class="tiao_r"><span><input type="number" name="r_num" value="${record.r_num }" required class="srk" /></span></div>
    </div>
    <div class="tiao1">
        <div class="tiao_l"><span>最低库存</span></div>
        <div class="tiao_r"><span><input type="number" name="r_minnum" value="${record.r_minnum }" required class="srk" /></span></div>
    </div>
    <div class="tiao1">
        <div class="tiao_l"><span>最高库存</span></div>
        <div class="tiao_r"><span><input type="number" name="r_maxnum" value="${record.r_maxnum }" required class="srk" /></span></div>
    </div>
    <div class="hui"></div>
    <div class="tiao1">
        <div class="tiao_l"><span>负责人</span></div>
        <div class="tiao_r"><span><input type="text" name="r_operate" value="${record.r_operate }" required class="srk" /></span></div>
    </div>
    <div class="hui"></div>
    <div class="tiao1">
        <div class="tiao_l"><span>备注</span></div>
        <div class="tiao_r"><span><input type="text" name="remark" value="${record.remark }" class="srk" /></span></div>
    </div>
    <div class="hui"></div>
