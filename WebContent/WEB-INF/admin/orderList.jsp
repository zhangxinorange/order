...
function searchlis(e){
	if(typeof(e)=="undefined")
	{
	 ...
	 window.location.href="${ctx}/order/orderList?orderName="+$("#orderName").val()+"&pageIndex="+e+"&userName="+$("#userName").val();
}
...
<body>
    ...
    <div class="tools">
        ...
        <ul class="toolbar1">
        	...
        	<li>用户名称:<input type="text"  class="dfinput_1" name="userName" id="userName" /></li>
    ...
    <table class="tablelist">
        ...
        <th>编号<i class="sort"><img src="${ctx }/static/images/px.gif" /></i></th>
         <th><font style="color: red">创建用户</font></th>
        <th>订单名称</th>
        <th>客户名称</th>
        <th>订单物资</th>
        <th>订单数量</th>
